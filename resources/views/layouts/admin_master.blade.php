...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('backend/assets/img/illustrations/cmpilogo.png') }}" />
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            {{-- author --}}
            <li class="menu-item {{ Route::is('admin.author.index') ? 'active':'' }}">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item {{ Route::is('admin.books.addBooks') ? 'active':'' }}">
                    <a href="{{ route('admin.books.addBooks') }}" class="menu-link">
                      <div data-i18n="Account">Add Books </div>
                    </a>
                  </li>
                  <li class="menu-item {{ Route::is('admin.books.allBooks') ? 'active':'' }}">
                    <a href="{{ route('admin.books.allBooks') }}" class="menu-link">
                      <div data-i18n="Account">All Books</div>
                    </a>
                  </li>
                </ul>
              </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img style="width: 40px; height:40px;" src="{{auth()->guard('admin')->user()->profile ? asset('storage/profile_img/'.auth()->guard('admin')->user()->profile) :env('DICEBEAR_LINK').auth()->guard('admin')->user()->name }} " alt class="rounded-circle" />
                    </div>
                  </a>
